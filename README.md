...
The project is currently at foundation stage: the monorepo, architecture modules, desktop shell, website shell, tooling, tests, and architecture decisions exist; product workflows and native terminal capabilities are intentionally deferred.
...
There are no Project/Task entities, state machines, PTY or ConPTY integration, Git Worktree commands, coding-agent adapters, SQLite/Drizzle persistence, terminal renderer, product UI, installer, updater, authentication, billing, or backend business service in this foundation.

...
const cases: readonly Case[] = [
  ...
  // Ctrl+C with selection => copy
  {
    ...
    composing: false,
    expected: 'COPY',
    label: 'Ctrl+C with selection copies',
  },
  // Ctrl+C without selection => send ETX
  {
    ...
    composing: false,
    expected: 'SEND_BYTES',
    label: 'Ctrl+C without selection sends ETX',
  },
  // Ctrl+Shift+C always copies
  {
    ...
    composing: false,
    expected: 'COPY',
    label: 'Ctrl+Shift+C copies regardless of selection',
  },
  {
    key: 'C',
    modifier: CTRL,
    ...
    composing: false,
    expected: 'COPY',
    label: 'Ctrl+Shift+C with selection copies',
  },
  ...
  },
  {
    ...
    composing: false,
    expected: 'PASTE',
    label: 'Ctrl+Shift+Insert pastes',
  },
  ...
  // Cmd on mac behaves like Ctrl
  {
    ...
    composing: false,
    expected: 'COPY',
    label: 'Cmd+C with selection copies',
  },
  {
    key: 'C',
    modifier: CMD,
    ...
    composing: false,
    expected: 'SEND_BYTES',
    label: 'Cmd+C without selection sends ETX',
  },
  {
    key: 'C',
    modifier: CMD,
  ...
  // IME composing => ignore
  {
    ...
    composing: true,
    expected: 'IGNORE',
    label: 'IME composing ignores Ctrl+C',
  },
  {
    key: 'V',
    modifier: CTRL,
    ...
    composing: true,
    expected: 'IGNORE',
    label: 'IME composing ignores Ctrl+V',
  },
